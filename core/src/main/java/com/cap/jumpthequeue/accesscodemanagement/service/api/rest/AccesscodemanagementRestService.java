...
public interface AccesscodemanagementRestService {
   ...
   *
   * @param searchCriteriaTo the pagination and search criteria to be used for finding accesscodes.
   * @return the {@link PaginatedListTo list} of matching {@link AccessCodeCto}s.
   */
  @Path("/accesscode/cto/search")
  @POST
  public PaginatedListTo<AccessCodeCto> findAccessCodeCtosByPost(AccessCodeSearchCriteriaTo searchCriteriaTo);
